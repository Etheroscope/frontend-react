        ...
        <Container>
          ...
          <ContractList>
            {contracts.map((contract, contractKey) => (
              <Row key={contractKey}>
                <Link href={`/explorer#${contract}`}><li>{contract}</li></Link>
